...
parts.append(	
	...
	union() (
		#Female side
		translate( [0,0,f_size/2] ) ( rotate( 90, [0,1,0] ) ( translate( [0,0,-5] ) (
		difference() (
			union() (
		...
		translate( [-middle_width/2,0,0] ) (
			cube( [middle_width, 10, 3] )
		),
		translate( [-middle_width/2,0,f_size-3] ) (
			cube( [middle_width, 10, 3] )
		),
		#Male side
		translate( [m_size/2.0+.5,0,0] ) (
