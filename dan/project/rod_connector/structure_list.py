...
class WP1(WallPiece):
    ...
    random.seed( seed )
    points = [Vec3(random.uniform(0, 1000), random.uniform(0, 1000), random.uniform(0, 100)) for i in range(point_count)]
...
class WP2(WallPiece):
    ...
    def height_func( x, y ):
        return (noise.snoise2( x*.003 + y * .03, y*.003 )+1) * 50

    random.seed( seed )
    #points = [Vec3(random.uniform(50, 950), random.uniform(50, 950), random.uniform(0, 100)) for i in range(point_count)]
    points = [Vec3(i % 8 * (1000/8.0) + (1000/16.0), i / 8 * (1000/8.0) + (1000/16.0), random.uniform(0, 100)) for i in range(point_count)]
...
class WP3(WallPiece):
    ...
    def height_func( x, y ):
        return 30 + (noise.snoise2( x*.005, y*.005 )+1) * 80
    ...
    while(True):
        ...
        for i in xrange( 10000 ):
            p = Vec3(random.uniform(inc*.5, width-inc*.5), random.uniform(inc*.5, width-inc*.5), random.uniform(30, 100))
            good = True
            for o in points:
...
class WP4(WallPiece):
    ...
    while(True):
        placed = False
        for i in xrange( 10000 ):
            p = Vec3(random.uniform(50, 950), random.uniform(50, 950), random.uniform(0, 100))
            good = True
            for o in points:
                if o.distance2( p ) < min_dist**2:
                    good = False
