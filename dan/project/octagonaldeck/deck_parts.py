...
def cube(*args, **kwargs):
    ...
    weight += reduce( lambda x, y: x*y, r.params['size'] ) * lbs_pcf
    return r
...
def outer_horiz_supports():
    ...
    # 16 inch separation
    parts.append(
        translate( [inches(16-.75), inches(1.5), deck_height-inches(5.5)] )(
            cube([inches(1.5), side-inches(3), inches(5.5)])
        )
    )

    parts.append(
        translate( [inches(32-.75), inches(1.5), deck_height-inches(5.5)] )(
            cube([inches(1.5), side-inches(3), inches(5.5)])
        )
    )
...
def square_section( railing=None, outer_supports=True ):
    ...
    parts.append(
        translate( [offset, offset, 0] )(
            cube([inches(3.5), inches(3.5), p1h])
        )
    )
    parts.append(
...
parts.append( right( side+inches(.5) ) ( square_section( railing='right') ) )
parts.append( left( side+inches(.5) ) ( square_section( railing='left') ) )
parts.append( forward( side+inches(.5) ) ( square_section( railing='forward') ) )
parts.append( back( side+inches(.5) ) ( square_section( railing='back') ) )
