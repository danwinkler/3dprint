...
connector_cutout = translate( [-1, wall_thickness, wall_thickness] ) (
    cube( [connector_length+2, board_2x4_width+buffer_room*2, board_2x4_height+buffer_room*2] )
)
...
connector_b = translate( [connector_2_x_offset, 0, connector_height] ) (
    rotate( v=[0,1,0], a=-connector_2_angle ) (
        connector.copy()
    )
)
...
full_connector += cube(
    [connector_length,
    connector_depth,
    connector_height+connector_2_y_offset]
)
full_connector += translate( [connector_length/2.0, 0, 0] ) (
    cube( [connector_length/2.0, connector_depth, connector_height+connector_2_sin*connector_length] )
)
...
screw_hole_short = cylinder( segments=12, r=2, h=connector_height+connector_2_sin * (screw_hole_short_x-connector_2_x_offset) + connector_2_sin*connector_depth*.5 )
screw_hole_long = cylinder( segments=12, r=2, h=connector_height+connector_2_sin * (screw_hole_long_x-connector_2_x_offset) + connector_2_sin*connector_depth*.5 )
