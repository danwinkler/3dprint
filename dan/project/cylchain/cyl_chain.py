...
def inset():
	return down( 15 ) (
		union() (
			...
			(cylinder( h=30, r=8.5, center=True ) * translate( [.5,.5,-50] ) ( cube( [100,100,100] ) )) - cylinder( h=31, r=6, center=True )
		)
	)
...
def grabber():
	return up( 15 ) ( 
		union() (
			...
			(cylinder( h=30, r=8, center=True ) * translate( [1,1,-50] ) ( cube( [100,100,100] ) )) 
