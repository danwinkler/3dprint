...
bottom -= translate( [wall_thickness, wall_thickness, wall_thickness] ) (
    cube( [inner_width, inner_length, inner_height*.5 + 1] )
)
bottom -= translate( [outer_x*.25, outer_y, outer_z] ) (
    hinge_cutout()
)

bottom -= translate( [outer_x*.75, outer_y, outer_z] ) (
    hinge_cutout()
)
